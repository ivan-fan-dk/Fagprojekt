...
u0 = 1
lambda0 = 1
u = lambda t: u0*np.exp(lambda0*t) 
X, y = fc.data(f=u, upper_bound=2, lower_bound=0, N=N0, inputdims=1)
...
fc.plot_comparison(X, y, predictions, plot_title="fabians plot", filename="h)_plot_h")